    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <img src="/logo.png" alt="KVT Logo" className="h-8 w-8" />
              <span className="text-xl font-bold">KVT</span>
            </div>
            <p className="text-gray-300 mb-4">
              {settings?.businessName || 'K. Vishwanathan Tex'}
            </p>
            <p className="text-gray-400 text-sm">
              Premium textile products since 2011. Serving customers across Tamil Nadu with quality shawls and textiles.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} {settings?.businessName || 'K. Vishwanathan Tex'}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
